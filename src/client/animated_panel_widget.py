...
class AnimatedPanel(QtWidgets.QFrame):
    ...
    def start_animation(self, 
        ...
        self.set_values_for_animation(start_value_pos if start_value_pos else QtCore.QPoint(7, self.parent.height() - 72.5),
                                      end_value_pos if end_value_pos else QtCore.QPoint(7, 28.5),
                                      start_value_size if start_value_size else QtCore.QSize(self.parent.width() - 13.5, 26.5),
                                      end_value_size if end_value_size else QtCore.QSize(self.parent.width() - 13.5, self.parent.height() - 72.5))
